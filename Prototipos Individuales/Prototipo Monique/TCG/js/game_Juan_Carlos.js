...
let cardPool = [
  { id:1, name:'Sombra Voraz', cost:1, atk:3, hp:3 },
  { id:2, name:'Imán Llamas', cost:2, atk:4, hp:4 },
  { id:3, name:'Látigo Umbral', cost:1, atk:2, hp:2 },
  { id:4, name:'Guardia Abisal', cost:3, atk:5, hp:6 },
  { id:5, name:'Bendición', cost:2, atk:1, hp:5 },
  { id:6, name:'Furia Carmesí', cost:4, atk:7, hp:5 },
  { id:7, name:'Eco Vacío', cost:2, atk:3, hp:3 },
  { id:8, name:'Tormentador', cost:3, atk:6, hp:4 },
  { id:9, name:'Pesadilla', cost:1, atk:2, hp:3 },
  { id:10, name:'Asesino', cost:2, atk:4, hp:3 }
];
...
function draw() {
  ...
  // Dibujar campo del rival
  drawOppField();
  
  // Dibujar campo del jugador
  drawPlayerField();
  ...
  // Dibujar pantalla de game over si corresponde
